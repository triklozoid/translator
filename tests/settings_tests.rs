...
fn test_save_load_last_language() {
    ...
    for lang in test_languages {
        ...
        assert_eq!(
            loaded_lang, lang,
            "Loaded language should match saved language"
        );
    }
...
fn test_load_language_with_invalid_content() {
    ...
    assert_eq!(
        lang,
        Language::English,
        "Should return default for invalid content"
    );
...
fn test_save_language_permissions_error() {
    ...
    let mut permissions = fs::metadata(&lang_file)
...
fn test_unsupported_language() {
    ...
    assert_eq!(
        lang,
        Language::English,
        "Should return default for unsupported code"
    );
