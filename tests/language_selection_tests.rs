...
fn test_language_selection_algorithm() {
    ...
    assert_eq!(
        result,
        Language::English,
        "Should translate to primary when source is not primary"
    );
    ...
    assert_eq!(
        result,
        Language::Spanish,
        "Should use last language when source is primary and last is meaningful"
    );
    ...
    assert_eq!(
        result,
        Language::French,
        "Should use secondary when source is primary and last is not meaningful"
    );
    ...
    assert_eq!(
        result,
        Language::English,
        "Should default to primary when source detection fails"
    );
}
